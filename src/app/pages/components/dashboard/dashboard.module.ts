...
// import { MemberComponent } from './desktop-dashboard/desktop-dashboard-booking/desktop-dashboard-booking-members/member/member.component';

@NgModule({
  declarations: [DashboardContainerComponent,
     DesktopDashboardComponent, MobileDashboardComponent, 
